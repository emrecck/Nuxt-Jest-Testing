...
export const actions = {
  nuxtServerInit(vuexContext, context){
    return axios.get("https://nuxt-js-79077-default-rtdb.firebaseio.com/products.json")
    .then((response) => {
      ...
      vuexContext.commit("addProduct",list)
  ...
  filtered(Context,search){
    Context.commit("filter",search)
  }
}